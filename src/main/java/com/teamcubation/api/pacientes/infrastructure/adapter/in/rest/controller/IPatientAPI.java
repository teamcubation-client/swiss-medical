...
public interface IPatientAPI {
    ...
    ResponseEntity<List<PatientResponse>> getAll(
    ...
    ResponseEntity<PatientResponse> getByDni(
            @Parameter(description = "DNI completo del paciente", example = "12345678")
            String dni
    );

    @Operation(summary = "Buscar paciente por nombre")
    ResponseEntity<List<PatientResponse>> getByName(
    ...
    ResponseEntity<List<PatientResponse>> getByHealthInsuranceProvider(
