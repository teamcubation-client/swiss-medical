...
public class PacienteController {
    ...
    @GetMapping
    public ResponseEntity<List<PacienteResponse>> obtenerPacientes(@RequestParam(required = false) String dni,
                                                                   @RequestParam(required = false) String nombre) {
        List<PacienteResponse> pacientes = this.pacienteService.obtenerPacientes(dni, nombre);
